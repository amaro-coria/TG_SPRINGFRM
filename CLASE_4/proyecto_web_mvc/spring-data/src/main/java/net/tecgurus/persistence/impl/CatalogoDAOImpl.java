...
public class CatalogoDAOImpl implements CatalogoDAO {
	...
	public Integer save(CatalogoGeneral c) {
		Integer i = (Integer) sessionFactory.getCurrentSession().save(c);
		return i;
	}
	...
	public List<CatalogoGeneral> findByDscCrt(String dsc) {
		/*
		String hql = "Select c From CatalogoGeneral c WHERE c.dscCorCat = :dsclocal";
		Query q = sessionFactory.getCurrentSession().createQuery(hql);
		q.setParameter("dsclocal", dsc);
		//q.setParameter(1, dsc);
		List<CatalogoGeneral> list = q.list();
		return list;
		*/
